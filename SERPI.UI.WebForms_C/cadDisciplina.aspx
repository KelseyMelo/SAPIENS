<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadDisciplina.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadDisciplina" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Disciplina</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button" runat="server" id="btnCriarDisciplina" name="btnCriarDisciplina" onserverclick="btnCriarDisciplina_Click" class="btn btn-success" href="#" onclick=""  > <%--onserverclick="btnCriarDisciplina_Click"--%>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <span>Código</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtCodigoDisciplina" type="text" value="" maxlength="7" />
                        </div>
                        ...
                        <div class="col-md-5">
                            <span>Nome</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtNomeDisciplina" type="text" value="" maxlength="150" />
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <asp:DropDownList runat="server" ID="ddlCodigoCursoDisciplina" ClientIDMode="Static" class="form-control input-sm select2 SemPesquisa" AutoPostBack="false">
                            </asp:DropDownList>
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        ...
                        <div class="col-md-5">
                            ...
                            <asp:DropDownList runat="server" ID="ddlNomeCursoDisciplina" ClientIDMode="Static" class="form-control input-sm select2" AutoPostBack="false">
                            </asp:DropDownList>
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        ...
                        <div class="col-md-1">
                            ...
                            <a id="aBntPerquisaAluno" runat ="server" onclick="fProcessando()" onserverclick="btnPerquisaDisciplina_Click"  href="#" class ="btn btn-success pull-right"><i class="fa fa-check"></i><span>&nbsp;OK</span></a> <%--onserverclick="bntPerquisaAluno_Click"--%>
                        </div>
                            ...
                            <div class="grid-content">
                                <div runat="server" id="msgSemResultados" visible="false">
                                    <div class="alert bg-gray">
                                        <asp:Label runat="server" ID="lblMsgSemResultados" Text="Nenhuma Disciplina encontrada" />
                                    </div>
                                </div>
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Tipo Curso - Sigla" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <%# setTipoMestrado(DataBinder.Eval(Container.DataItem, "cursos_disciplinas"))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('input').iCheck({
                ...
                increaseDisciplina: '20%' // optional
            });
        ...
        $('#<%=ddlCodigoCursoDisciplina.ClientID%>').on("select2:select", function(e) { 
            //alert($(this).val());
            $("#<%=ddlNomeCursoDisciplina.ClientID%>").val($(this).val()).trigger("change");
            $('#<%=divResultados.ClientID%>').hide();
        });

        $('#<%=ddlNomeCursoDisciplina.ClientID%>').on("select2:select", function(e) { 
            //alert($(this).val());
            $("#<%=ddlCodigoCursoDisciplina.ClientID%>").val($(this).val()).trigger("change");
            $('#<%=divResultados.ClientID%>').hide();
        });
