<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index_dissertacoes.aspx.cs" Inherits="SERPI.UI.WebForms_C.index_dissertacoes" %>
...
<head runat="server">
    ...
    <style>
        ...
        .bannerRosto_interno {
            background: url('img/homepage/dissertacoes.jpg');
    ...
    <form id="form2" runat="server">
            ...
            <section id="sectionBanner" runat="server" class="bannerRosto_interno">
                ...
                <div id="texto-img" class="text-center">
                    <h1 class="text-center"><strong>
                        <asp:Label ID="lblTipoCurso" runat="server" Text="Dissertações"></asp:Label></strong></h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" style="font-family: Helvetica,Arial,Lucida,sans-serif; text-align: left; font-size: 1.8rem;">
                                <p style="line-height:1.8em">
                                    Neste espaço você encontra o acervo de dissertações defendidas nos Programas de Mestrado do IPT. O acesso ao texto completo das dissertações em formato digital é disponibilizado livremente, com o objetivo de difundir o conhecimento produzido na instituição para a sociedade.
                                </p>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p style="text-transform:uppercase">
                                    <strong>Ano de publicação das Dissertações</strong>
                                </p>
                                <div class="row">
                                    ...
                                    <div id="res_1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="cab_1">
                                        <div class="panel-body">
                                            <p style="font-size: 1.3rem; line-height: 1.5em">
                                                ...
                                                <br />
                                                <br />
                                                <a class="btn btn-primary btn-outline" target="_blank" onclick="fGoToDownload(1)" href="\Teses\Resposta Anexo 1.pdf"><b>Faça aqui o <em>download</em> da dissertação</b></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>--%>
                            ...
                            <div id="divBotaoCarregaDissertacoes" class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-default btn-sm" onclick="fMaisDissertacoes()">
                                        <i class="fa fa-refresh fa-spin"></i>&nbsp;&nbsp;carregar mais dissertações...</button>
                                </div>
                            </div>
        ...
        <script>
            ...
            function fMaisDissertacoes() {
                ...
                try {
                    $.ajax({
                        url: "wsInscricao.asmx/fMaisDissertacoes",
                        data: formData,
                        type: 'POST',
                        cache: false,
                        contentType: false,
                        ...
                        success: function (json) {
                            ...
                            for (var i = 0; i < json.length; i++) {
                                ...
                                else
                                {
                                    ...
                                    sAux = sAux + "                <br />";
                                    sAux = sAux + "                <br />";
                                    sAux = sAux + "                <a class=\"btn btn-primary btn-outline\" target=\"_blank\" onclick=\"fGoToDownload(" + qObjeto + "," + json[i].P9 + ")\" href=\"\Teses\\" + json[i].P8 + "\"><b>Faça aqui o <em>download</em> da dissertação</b></a>";
                                    sAux = sAux + "            </p>";
                                    sAux = sAux + "        </div>";
                                    sAux = sAux + "    </div>";
                                    sAux = sAux + "</div>";
        ...
        <script>
              ...
              gtag('config', 'UA-154434342-1', {
                  'page_title': 'Página Dissertações',
                  'page_path': '/dissertacoes.aspx'
              });
        </script>
