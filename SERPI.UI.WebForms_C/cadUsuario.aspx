<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadUsuario.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadUsuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <asp:Literal ID="litMenu" runat="server"></asp:Literal>
    <input type="hidden" id ="hGrupoMenu"  name="hGrupoMenu" value="liAdmSistema" /> 
    <input type="hidden" id ="hItemMenu"  name="hItemMenu" value="liCadUsuario" />
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Usuário</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarUsuario" name="btnCriarUsuario" onserverclick="btnCriarUsuario_Click" class="btn btn-success" href="#" onclick=""  > <%--onserverclick="btnCriarUsuario_Click"--%>
                        <i class="fa fa-magic"></i>&nbsp;Criar Usuário</button>
            </div>
        </div>
    </div>
    <br />
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <span>Nome</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtNomeUsuario" type="text" maxlength="150"/>
                        </div>
                        <div class="hidden-lg hidden-md">
                         ...
                         <div class="col-md-3">
                            <span>Grupo</span><br />
                            <asp:DropDownList runat="server" ID="ddlGrupo" ClientIDMode="Static" class="form-control input-sm select2 SemPesquisa" AutoPostBack="false">
                            </asp:DropDownList>
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        ...
                        <div class="col-md-1">
                            ...
                            <a id="aBntPerquisaUsuario" runat ="server" onclick="fProcessando()" onserverclick="btnPerquisaUsuario_Click"  href="#" class ="btn btn-success pull-right"><i class="fa fa-check"></i><span>&nbsp;OK</span></a> <%--onserverclick="bntPerquisaAluno_Click"--%>
                        </div>
                            ...
                            <div class="grid-content">
                                <div runat="server" id="msgSemResultados" visible="false">
                                    <div class="alert bg-gray">
                                        <asp:Label runat="server" ID="lblMsgSemResultados" Text="Nenhum Usuário encontrado" />
                                    </div>
                                </div>
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="usuario"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="grupos_acesso.grupo" HeaderText="Grupo" ItemStyle-HorizontalAlign="Left" />

                                            <asp:BoundField DataField="nome" HeaderText="Nome" ItemStyle-HorizontalAlign="Left" />

                                            <asp:BoundField DataField="email" HeaderText="E-mail" ItemStyle-HorizontalAlign="Left" />

                                            <asp:BoundField DataField="usuario" HeaderText="Login" ItemStyle-HorizontalAlign="Left" />

                                            <asp:BoundField DataField="nomeSocial" HeaderText="Nome Social" ItemStyle-HorizontalAlign="Left" />

                                            <asp:TemplateField HeaderText="Situação" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "status").ToString() == "0" ? "<div class='text-danger'><strong>INATIVO</strong></div>" : "Ativo"%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Bloqueado" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#setBloqueio(DataBinder.Eval(Container.DataItem,"usuarios_log") )    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script>
        ...
        function teclaEnter() {
            if (event.keyCode == "13") {
                ...
                document.getElementById("<%=aBntPerquisaUsuario.ClientID%>").click();
            }
        }
