<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="finListaInadimplenteFIPT.aspx.cs" Inherits="SERPI.UI.WebForms_C.finListaInadimplenteFIPT" validateRequest="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <asp:Literal ID="litMenu" runat="server"></asp:Literal>
    <input type="hidden" id ="hGrupoMenu"  name="hGrupoMenu" value="liFinanceiro" /> 
    <input type="hidden" id ="hItemMenu"  name="hItemMenu" value="liListaInadimplentesFIPT" />
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <style type="text/css">
        ...
        .icon-input-btn .glyphicon {
         ...
         #ContentPlaceHolderBody_grdAluno_InadimplenteFIPT td.centralizarTH {
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-green"></i>&nbsp;<strong >Alunos Inadimplentes FIPT</strong>(Listagem)</h3>
        </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <span>Curso</span><br />
                            <input class="form-control input-sm alteracao" runat="server" id="txtCursoAluno" type="text" value="" maxlength="150" />
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input class="form-control input-sm alteracao" runat="server" id="txtDataAPartirDe" type="date" value="" />
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <button  runat="server" id="btnPesquisaListaInadimplenteFIPT" name="btnPesquisaListaInadimplenteFIPT" title="" class="btn btn-success pull-right hidden " href="#">  <%--onserverclick ="btnPesquisaListaInadimplenteFIPT_Click" --%>
                                <i class="glyphicon glyphicon-ok"></i>&nbsp;OK</button>

                            <a id="abtnPesquisaListaInadimplenteFIPT" name="abtnPesquisaListaInadimplenteFIPT" runat ="server" onclick="if (fProcessando()) return;" class ="btn btn-success pull-right" onserverclick="btnPesquisaListaInadimplenteFIPT_Click"><i class="glyphicon glyphicon-ok"></i><span>&nbsp;OK</span></a> <%--onserverclick="btnPesquisaListaInadimplenteFIPT_Click"--%>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="grid-content">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdAluno_InadimplenteFIPT" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="id_aluno_curso_Inadimplente"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ordem" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "alunos_inadimpentes_fipt.nome")  %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Ordem2" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "NomeCurso") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="alunos_inadimpentes_fipt.idaluno" HeaderText="Matrícula" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>

                                            <asp:BoundField DataField="alunos_inadimpentes_fipt.nome" HeaderText="Nome" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>

                                            <asp:BoundField DataField="NomeCurso" HeaderText="Curso" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>

                                            <asp:BoundField DataField="alunos_inadimpentes_fipt.email" HeaderText="E-mail" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>

                                            <asp:TemplateField HeaderText="Data Cálculo" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Justify"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%# String.Format("{0:dd/MM/yyyy}", DataBinder.Eval(Container.DataItem,"alunos_inadimpentes_fipt.data_pesquisa_fipt")) %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="QTD Parc. Atrasadas" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%#setParcelasAtrazadas(DataBinder.Eval(Container.DataItem,"alunos_parcelas_inadimplente"))    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Valor Total (atualizado)" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%#setValorTotal(DataBinder.Eval(Container.DataItem,"alunos_parcelas_inadimplente"))    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Enviar E-mail (individual)" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%#setBotaoEmail(DataBinder.Eval(Container.DataItem,"alunos_inadimpentes_fipt"), Convert.ToInt32(DataBinder.Eval(Container.DataItem,"id_aluno_curso_inadimplente")))    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Enviar E-mail (lote)" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%#setCheckEmail(DataBinder.Eval(Container.DataItem,"alunos_inadimpentes_fipt"), Convert.ToInt32(DataBinder.Eval(Container.DataItem,"id_aluno_curso_inadimplente")))    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Recalcular (individual)" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%#setRecalcularAluno(DataBinder.Eval(Container.DataItem,"alunos_inadimpentes_fipt"))    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%--<asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <span style="position: relative;">
                                                        ...
                                                        <asp:Button OnClientClick="ShowProgress()" HorizontalAlign="Center" CssClass="movedown" HeaderText="Editar" ID="btnStart" runat="server" Text="" OnCommand="grdAluno_InadimplenteFIPT_Command" CommandName="StartService" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
...
<%--    
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#<%=grdAluno_InadimplenteFIPT.ClientID%>').dataTable({
                stateSave: true,
                "bProcessing": true,
                "columns": [
                    { "orderable": false },
                    ...
                    { width: "2500px"},  // Curso
                    { width: "50px"},  // Email
                    { width: "10px"},  //  Data Calculo
                    { width: "10px"},  //Qtd Parcela
                    { width: "10px" },  //Valor Atualizado
                    { width: "10px"},  //Data Inclusão/Exclusão Serasa 
                    { width: "10px" }, //Data Envio Email
                    { width: "5px", "orderable": false},  //Ocorrencia
                    //{ width: '5%'}, //Data Exclusão
                ...
                buttons: [
                {
                    ...
                    title: function () {
                            ...
                            if (document.getElementById("<%=txtCursoAluno.ClientID%>").value != "") {
                                fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Curso: " + document.getElementById("<%=txtCursoAluno.ClientID%>").value;
                            }
                            if (document.getElementById("<%=txtDataAPartirDe.ClientID%>").value != "") {
                                var sAux = document.getElementById("<%=txtDataAPartirDe.ClientID%>").value;
                                //2015-02-01
            ...
            $('#<%=grdAluno_InadimplenteFIPT.ClientID%>').on('draw.dt', function() {
                fDesenhaCheckBox();
            });
        ...
        function fRetornoFiltro(qFormato) {
            ...
            if (document.getElementById("<%=txtCursoAluno.ClientID%>").value != "") {
                fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Nome Curso: " + document.getElementById("<%=txtCursoAluno.ClientID%>").value;
            }
        ...
        function fLocalizaEmailsLote() {
            var data = $('#<%=grdAluno_InadimplenteFIPT.ClientID%>').DataTable().$('input').serialize();
