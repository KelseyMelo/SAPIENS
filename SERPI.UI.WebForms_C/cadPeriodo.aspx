<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadPeriodo.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadPeriodo" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Período</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarPeriodo" name="btnCriarPeriodo" onserverclick="btnCriarQuadrimestre_Click" class="btn btn-success" href="#" onclick=""  > <%--onserverclick="btnCriarPeriodo_Click"--%>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <span>Ano</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtAnoPeriodo" type="number" min="1900" max="9000" />
                        </div>
                        <div class="hidden-lg hidden-md">
                         ...
                         <div class="col-md-3">
                            ...
                            <asp:DropDownList runat="server" ID="ddlTipoCursoPeriodo" ClientIDMode="Static" class="form-control input-sm select2 SemPesquisa" AutoPostBack="false">
                            </asp:DropDownList>
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        ...
                        <div class="col-md-2">
                            ...
                            <a id="aBntPerquisaPeriodo" runat ="server" onclick="ShowProgress()" onserverclick="btnPerquisaQuadrimestre_Click"  href="#" class ="btn btn-success pull-right"><i class="fa fa-check"></i><span>&nbsp;OK</span></a> <%--onserverclick="bntPerquisaAluno_Click"--%>
                        </div>
                            ...
                            <div class="grid-content">
                                <div runat="server" id="msgSemResultados" visible="false">
                                    <div class="alert bg-gray">
                                        <asp:Label runat="server" ID="lblMsgSemResultados" Text="Nenhum Período encontrado" />
                                    </div>
                                </div>
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="quadrimestre"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ordem" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "ano").ToString() + DataBinder.Eval(Container.DataItem, "numero").ToString()%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Tipo Curso" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "id_tipo_curso") == null ? "Mestrado" : DataBinder.Eval(Container.DataItem, "tipos_curso.tipo_curso")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script>
        ...
        function teclaEnter() {
            if (event.keyCode == "13") {
                ...
                document.getElementById("<%=aBntPerquisaPeriodo.ClientID%>").click();
            }
        }
