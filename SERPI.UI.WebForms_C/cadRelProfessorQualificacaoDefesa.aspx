<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadRelProfessorQualificacaoDefesa.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadRelProfessorQualificacaoDefesa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <input type="hidden" id ="hItemMenu2"  name="hItemMenu2" value="liCadRelProfessorQualificacaoDefesa" />
...
float:left;
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Relatório de Qualificações/Defesas do Professor</strong></h3>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="grid-content">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdProfessorQualificacaoDefesa" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="id_professor"
                                        SkinID="grid" CellPadding="4" ForeColor="#333333" GridLines="None" onrowdatabound="grdProfessorQualificacaoDefesa_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="tipo_professor" HeaderText="Papel" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>
...
<%--    
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#<%=grdProfessorQualificacaoDefesa.ClientID%>').dataTable({
                stateSave: false,
                ...
                buttons: [
                {
                    ...
                    title: function () {
                        //var qPulaLinha = "\n";
                        var qPulaLinha = " - ";
                        var fRetornoFiltro = "Relatório de Bancas do Professor - " + document.getElementById("<%=ddlTipoQualificacaoDefesa.ClientID%>").value;
                    ...
                    filename: 'Relatorio_Professor_' + document.getElementById("<%=ddlTipoQualificacaoDefesa.ClientID%>").value,
