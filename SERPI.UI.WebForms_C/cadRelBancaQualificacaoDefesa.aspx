<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadRelBancaQualificacaoDefesa.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadRelBancaQualificacaoDefesa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <input type="hidden" id ="hItemMenu2"  name="hItemMenu2" value="liCadRelBancaQualificacaoDefesa" />
...
float:left;
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Relatório de Bancas de Qualificação/Defesa</strong></h3>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="grid-content">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdBancaQualificacaoDefesa" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="id_banca" HeaderText="ID" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>
                                            ...
                                            <asp:BoundField DataField="banca.matricula_turma.alunos.email" HeaderText="E-mail" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>
                                            ...
                                            <asp:BoundField DataField="professores.nome" HeaderText="Orientador" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
...
<%--    
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#<%=grdBancaQualificacaoDefesa.ClientID%>').dataTable({
                stateSave: false,
                ...
                buttons: [
                {
                    ...
                    title: function () {
                        //var qPulaLinha = "\n";
                        var qPulaLinha = " - ";
                        var fRetornoFiltro = "Relatório de Bancas de " + document.getElementById("<%=ddlTipoQualificacaoDefesa.ClientID%>").value;
                    ...
                    filename: 'Relatorio_Banca_' + document.getElementById("<%=ddlTipoQualificacaoDefesa.ClientID%>").value,
