<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outDownloadCertificado.aspx.cs" Inherits="SERPI.UI.WebForms_C.outDownloadCertificado" %>
    ...
    <form id="FORM" name="FORM" method="post" runat="server">
            ...
            <div class ="container">
                ...
                <div class ="row">
                    ...
                    <div class="col-md-8 pull-left wow fadeInLeft animated animated"  data-wow-duration="3s"  style="visibility: visible; animation-name: fadeInLeft;">
                        <br /><br />
                        <h2 style="line-height: 1em;" ><font color="#FFFFFF" style="text-shadow: 2px 2px 4px #000">Ensino Tecnológico - IPT</font></h2>

                        <h3 class="hidden" style="line-height: 1em;" ><font color="#FFFFFF" style="text-shadow: 2px 2px 4px #000">SAPIENS</font></h3>
                        <br />
        ...
        <section >
            <div class="container">
                ...
                <div class ="row" runat="server" id="divRowSenha">
                    <div class ="col-md-4">
                        <span>Digite a senha enviada por e-mail</span><br />
                        <input runat="server" id="txtSenhaEmail" class="form-control input-sm" type="password" value="" />
                    </div>
                    ...
                    <div class ="col-md-4">
                        <br />
                        <button runat="server" type="button" id="btnBaixarCertificado" name="btnBaixarCertificado" class="btn btn-success" href="#"  onserverclick="btnBaixarCertificado_Click">
                            <i class="fa fa-download"></i>&nbsp;Ok
                        </button>
                    </div>
