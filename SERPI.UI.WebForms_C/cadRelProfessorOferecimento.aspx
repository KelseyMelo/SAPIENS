<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadRelProfessorOferecimento.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadRelProfessorOferecimento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <input type="hidden" id ="hItemMenu2"  name="hItemMenu2" value="liCadRelProfessorOferecimentos" />
...
float:left;
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Relatório de Oferecimentos do Professor</strong></h3>
        </div>
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdProfessorOferecimento" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Resp." HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "responsavel")) ? "sim" : "" %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Ativo" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "oferecimentos.ativo")) ? "sim" : "" %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<%--    
    ...
    <script>
            ...
            $('#<%=grdProfessorOferecimento.ClientID%>').dataTable({
                ...
                buttons: [
                {
                    ...
                    title: function () {
                        //var qPulaLinha = "\n";
                        var qPulaLinha = " - ";
                        var fRetornoFiltro = "Relatório de Oferecimentos do Professor";
                    ...
                    filename: 'Relatorio_Oferecimento_Professor',
        ...
        function fRetornoFiltro(qFormato) {
            ...
            fRetornoFiltro = "Relatório de Oferecimentos do Professor";
            if (document.getElementById("<%=txtCpfProfessor.ClientID%>").value != "") {
                fRetornoFiltro = fRetornoFiltro + qPulaLinha + " CPF: " + document.getElementById("<%=txtCpfProfessor.ClientID%>").value;
            }
            if (document.getElementById("<%=txtNomeProfessor.ClientID%>").value != "") {
