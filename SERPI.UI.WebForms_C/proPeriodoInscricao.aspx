<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="proPeriodoInscricao.aspx.cs" Inherits="SERPI.UI.WebForms_C.ProcessoSeletivo.proPeriodoInscricao" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-fuchsia"></i>&nbsp;<strong >Períodos de Inscrição</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarPeriodoInscricao" name="btnCriarPeriodoInscricao" class="btn btn-success" href="#" onserverclick="btnCriarPeriodoInscricao_Click" >
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control input-sm alteracao" runat="server" id="txtDataInicioPeriodoInscricao" type="date" value="" />
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control input-sm alteracao" runat="server" id="txtDataFimPeriodoInscricao" type="date" value="" />
                        </div>
                        <div class="hidden-lg hidden-md">
                            <br />
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <button type="button" runat="server" id="bntPerquisaPeriodoInscricao" name="bntPerquisaPeriodoInscricao" onserverclick="bntPerquisaPeriodoInscricao_Click" onclick="if (fProcessando()) return;" title="" class="btn btn-success pull-right ">
                            ...
                            <div class="grid-content">
                                <div runat="server" id="msgSemResultados" visible="false">
                                    <div class="alert bg-gray">
                                        <asp:Label runat="server" ID="lblMsgSemResultados" Text="Nenhum Período de Inscrição encontrado" />
                                    </div>
                                </div>
                                <div class="table-responsive ">

                                    <asp:GridView ID="grdPeriodoInscricao" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="quadrimestre" HeaderText="Descrição do Período" ItemStyle-HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <span style="position: relative;">
                                                        ...
                                                        <asp:Button OnClientClick="fProcessando()" HorizontalAlign="Center" CssClass="movedown" HeaderText="Editar" ID="btnStart" runat="server" Text="" OnCommand="grdPeriodoInscricao_Command" CommandName="StartService" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<%--    <script src="Scripts/jquery.datatable.1.10.13.min.js"></script>--%>
    ...
    <script>
        ...
        function teclaEnter() {
            if (event.keyCode == "13") {
                //alert('oi');
                document.getElementById("<%=bntPerquisaPeriodoInscricao.ClientID%>").click();
            }
        }
        ...
        $(document).ready(function () {
            ...
            $('#<%=grdPeriodoInscricao.ClientID%>').dataTable({
                stateSave: false,
                "bProcessing": true,
                columnDefs: [{ type: 'date-euro', targets: 1 }, { type: 'date-euro', targets: 2 }],
                order: [[1, 'desc']]
            });
