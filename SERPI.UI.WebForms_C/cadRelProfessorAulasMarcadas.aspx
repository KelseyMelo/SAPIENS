<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadRelProfessorAulasMarcadas.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadRelProfessorAulasMarcadas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <input type="hidden" id ="hItemMenu2"  name="hItemMenu2" value="liCadRelProfessorAulasMarcadas" />
...
float:left;
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Relatório de Professores com Aulas Marcadas</strong></h3>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <asp:DropDownList runat="server" ID="ddlMesCalculoCusto" ClientIDMode="Static" class="ddl_fecha_grid_resultados form-control input-sm select2 SemPesquisa" AutoPostBack="false">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row center-block btn-default form-group">
                                <div class="col-md-4">
                                <asp:RadioButton GroupName="GrupoPresente" ID="optPresenteTodos" runat="server"/>
                                &nbsp;
                                <label class="opt" for="<%=optPresenteTodos.ClientID %>">Todas</label>
                                </div>
                                
                                <div class="col-md-4">                    
                                <asp:RadioButton GroupName="GrupoPresente" ID="optPresenteSim" runat="server" />
                                &nbsp;
                                <label class="opt" for="<%=optPresenteSim.ClientID %>">Presença</label>
                                </div>

                                <div class="col-md-4">
                                <asp:RadioButton GroupName="GrupoPresente" ID="optPresenteNao" runat="server" Checked="true"/>
                                &nbsp;
                                <label class="opt" for="<%=optPresenteNao.ClientID %>">Falta</label>
                                </div>
                            </div>
<%--                            <asp:DropDownList runat="server" ID="ddlSexoAluno" ClientIDMode="Static" class="form-control input-sm select2 SemPesquisa" AutoPostBack="false">
                        ...
                        <div class="col-md-1">
                            ...
                            <button  runat="server" id="btnPerquisaProfessor" name="btnPerquisaProfessor" onclick="if (fProcessando()) return;" onserverclick ="btnPerquisaProfessor_Click" title="" class="btn btn-success pull-right">
                        ...
                        <div class="col-md-12">
                            <div class="grid-content">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdProfessorOferecimento" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="id_aula"
                                        SkinID="grid" CellPadding="4" ForeColor="#333333" GridLines="None" onrowdatabound="grdProfessorOferecimento_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="id_professor" HeaderText="id Prof." ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH"/>
                                            ...
                                            <asp:TemplateField HeaderText="Cód. Curso" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%#SetCurso(DataBinder.Eval(Container.DataItem,"oferecimentos.disciplinas.cursos_disciplinas") )    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="oferecimentos.disciplinas.codigo" HeaderText="Cód. Discplina" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>

                                            <asp:BoundField DataField="oferecimentos.disciplinas.nome" HeaderText="Nome Discplina" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>

                                            <asp:BoundField DataField="id_oferecimento" HeaderText="id Ofer." ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>

                                            <asp:BoundField DataField="oferecimentos.quadrimestre" HeaderText="Período" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"/>

                                            <asp:TemplateField HeaderText="Data Aula" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "datas_aulas.data_aula")).ToString("dd/MM/yyyy") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Situação" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "presente")) ? "Presença" : "<strong class=\"text-danger\">Falta</strong>" %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%--<asp:TemplateField HeaderText="RG" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Justify"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                                                <ItemTemplate>
                                                    <%#setRG(DataBinder.Eval(Container.DataItem, "numero_documento").ToString(), DataBinder.Eval(Container.DataItem, "digito_num_documento") == null ? "" : DataBinder.Eval(Container.DataItem, "digito_num_documento").ToString())    %>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
...
<%--    
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#<%=grdProfessorOferecimento.ClientID%>').dataTable({
                stateSave: false,
                ...
                "columns": [
                    ...
                    { width: "10px" },  //Cod Curso
                    { width: "10px" },  //Cod Disciplina
                    { width: "50px" },  //Nome Disciplina
                    { width: "10px" },  //Responsavel
                    { width: "10px" },  //Ativo
                    { width: "10px" },  //Período
                ...
                buttons: [
                {
                    ...
                    title: function () {
                        //var qPulaLinha = "\n";
                        var qPulaLinha = " - ";
                        var fRetornoFiltro = "Relatório de Professores com Aulas Marcadas";
                        fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Mês: " + $("#<%=ddlMesCalculoCusto.ClientID%> option:selected").text();
                        fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Ano: " + document.getElementById("<%=txtAnoCalculoCusto.ClientID%>").value;

                        if ($("#<%=optPresenteTodos.ClientID%>").attr("checked")) {
                            //alert("todos")
                            fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Situação: Todos";
                        }
                        else if($("#<%=optPresenteSim.ClientID%>").attr("checked")) {
                             //alert("sim")
                            fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Situação: Sim";
                        }
                        else {
                            //alert("nao")
                            fRetornoFiltro = fRetornoFiltro + qPulaLinha + " Situação: Não";
                        }
                        
                        return fRetornoFiltro;
                    },
                    filename: 'Relatorio_Professores_Aulas_Marcadas',
        ...
        function fRetornoFiltro(qFormato) {
            ...
            fRetornoFiltro = "Relatório de Professores com Aulas Marcadas";
