<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="telaCadastro.aspx.cs" Inherits="SERPI.UI.WebForms_C.telaCadastro" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-red"></i>&nbsp;<strong >Eventos</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarEvento" name="btnCriarEvento" onserverclick="btnCriarMonitor_Click" class="btn btn-success" href="#" onclick=""  > <%--onserverclick="btnCriarEvento_Click"--%>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <span>Evento</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtDescricaoEvento" type="text"/>
                        </div>
                        <div class="hidden-lg hidden-md">
                         ...
                         <div class="col-md-3">
                            ...
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtDataEvento" type="date"/>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="row center-block btn-default form-group">
                                <div class="col-md-4">
                                <asp:RadioButton GroupName="GrupoCoffee" ID="optCoffeeTodos" runat="server" Checked="true"/>
                                &nbsp;
                                <label class="opt" for="<%=optCoffeeTodos.ClientID %>">Todos</label>
                                </div>
                                
                                <div class="col-md-4">                    
                                <asp:RadioButton GroupName="GrupoCoffee" ID="optCoffeeSim" runat="server" />
                                &nbsp;
                                <label class="opt" for="<%=optCoffeeSim.ClientID %>">com coffee</label>
                                </div>

                                <div class="col-md-4">
                                <asp:RadioButton GroupName="GrupoCoffee" ID="optCoffeeNao" runat="server" />
                                &nbsp;
                                <label class="opt" for="<%=optCoffeeNao.ClientID %>">sem coffee</label>
                                </div>
                            </div>
                        </div>
                        <div class="hidden-lg hidden-md">
                        ...
                        <div class="col-md-1">
                            ...
                            <a id="aBntPerquisaEvento" runat ="server" onclick="fProcessando()" onserverclick="btnPerquisaMonitor_Click"  href="#" class ="btn btn-success pull-right"><i class="fa fa-check"></i><span>&nbsp;OK</span></a> <%--onserverclick="bntPerquisaAluno_Click"--%>
                        </div>
                            ...
                            <div class="grid-content">
                                <div runat="server" id="msgSemResultados" visible="false">
                                    <div class="alert bg-gray">
                                        <asp:Label runat="server" ID="lblMsgSemResultados" Text="Nenhum Evento encontrado" />
                                    </div>
                                </div>
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ordem" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "id_monitor").ToString()%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="id_monitor" HeaderText="Código" ItemStyle-HorizontalAlign="Center" />
                                            ...
                                            <asp:BoundField DataField="Dataeventomonitor" HeaderText="Data" ItemStyle-HorizontalAlign="Left" />

                                            <asp:BoundField DataField="Horarioeventomonitor" HeaderText="Horário" ItemStyle-HorizontalAlign="Center" />
                                            ...
                                            <asp:TemplateField HeaderText="Data Início (monitor)" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#String.Format("{0:dd/MM/yyyy HH:mm}", DataBinder.Eval(Container.DataItem, "datainicio"))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Data Fim (monitor)" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#String.Format("{0:dd/MM/yyyy HH:mm}", DataBinder.Eval(Container.DataItem, "datafim"))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Ativar/Inativar" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%# setLinkAtivacao(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "id_monitor")), DataBinder.Eval(Container.DataItem, "DescEventoMonitor").ToString(),DataBinder.Eval(Container.DataItem, "ativo").ToString())%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h4 class="modal-title" id="H1"><i class="fa fa-toggle-off"></i>&nbsp;Inativar Evento
                    </h4>
                </div>
                <div id="Div2" class="modal-body">
                    <strong>Deseja Inativar o Evento:</strong> <label class="csslblEvento">test</label> (<label class="csslblIdEvento">test</label>)?
                </div>
                <div class="modal-footer">
                    ...
                    <div class="pull-right">
                        ...
                        <span class="icon-input-btn"><span class="glyphicon glyphicon-check"></span>
                            <button runat="server" id="btnInativarEvento" name="btnInativarEvento" class="btn btn-success" href="#" onserverclick="btnInativar_Click">
    ...
    <div class="modal fade" id="divModalAtivar" tabindex="-1" role="dialog" aria-labelledby="CabecalhoMensagem" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h4 class="modal-title" id="H3"><i class="fa fa-toggle-on"></i>&nbsp;Ativar Evento
                    </h4>
                </div>
                <div id="Div4" class="modal-body">
                    <strong>Deseja Ativar o Evento:</strong> <label class="csslblEvento">test</label> (<label class="csslblIdEvento">test</label>)?
                </div>
                <div class="modal-footer">
                    ...
                    <div class="pull-right">
                        ...
                        <span class="icon-input-btn"><span class="glyphicon glyphicon-check"></span>
                            <button runat="server" id="btnAtivarEvento" name="btnAtivarEvento" class="btn btn-success" href="#" onserverclick="btnAtivar_Click">
                                <i class="fa fa-check"></i>&nbsp;Confirma</button>
                        </span>
    ...
    <script>
        ...
        function teclaEnter() {
            if (event.keyCode == "13") {
                ...
                document.getElementById("<%=aBntPerquisaEvento.ClientID%>").click();
            }
        }
        ...
        function AbreModalDesativar(qId, qDescricao) {
            ...
            $(".csslblEvento").html(qDescricao);
            $(".csslblIdEvento").html(qId);
