<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="outCadAutAluno.aspx.cs" Inherits="SERPI.UI.WebForms_C.outCadAutAluno" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-purple"></i>&nbsp;<strong >Cadastro Automático de Alunos</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarCadastroAlunos" name="btnCriarCadAutAlunosAlunos" onserverclick="btnCriarCadAutAlunosAlunos_Click" class="btn btn-success" href="#" onclick=""  > <%--onserverclick="btnCriarCadAutAlunosAlunos_Click"--%>
                        <i class="fa fa-magic faa-shake animated"></i>&nbsp;Importar Lote de Cadastro de Alunos</button>
            </div>
        </div>
    </div>
    <br />
        ...
        <div class="row">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <span>Descrição do Lote</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtDescricao" type="text" value="" maxlength ="200"/>
                        </div>

                        <div class="col-md-5">
                            <span>Curso Alvo</span><br />
                            <input class="form-control input-sm fecha_grid_resultados" runat="server" id="txtDescricao_Curso" type="text" value="" maxlength ="300"/>
                        </div>
                        ...
                        <div class="col-md-1">
                            ...
                            <a id="aPerquisaCadAutAlunosAlunos" runat ="server" onclick="fProcessando()" onserverclick="btnPerquisaCadAutAlunosAlunos_Click"  href="#" class ="btn btn-success pull-right"><i class="fa fa-check"></i><span>&nbsp;OK</span></a> <%--onserverclick="bntPerquisaAluno_Click"--%>
                        </div>
                            ...
                            <div class="grid-content">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        AllowPaging="True" PageSize="1000000" AllowSorting="true" DataKeyNames="id_cadastro_automatico"
                                        SkinID="grid" CellPadding="4" ForeColor="#333333" GridLines="None">
                                        <%--<AlternatingRowStyle BackColor="#000022" />--%>
                                        <Columns>

                                            <asp:BoundField DataField="id_cadastro_automatico" HeaderText="Id" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH"/>

                                            <asp:BoundField DataField="descricao" HeaderText="Descrição do Lote" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="centralizarTH"/>

                                             <asp:BoundField DataField="descricao_curso" HeaderText="Curso Alvo" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="centralizarTH"/>

                                            <asp:TemplateField HeaderText="Data Importação" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="Center centralizarTH" HeaderStyle-CssClass="Center">
                                                <ItemTemplate>
                                                    <%# Convert.ToDateTime(DataBinder.Eval(Container.DataItem,"data_importacao").ToString()).ToString("dd/MM/yyyy") %>
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('input').iCheck({
                ...
                increaseCadAutAlunosAlunos: '20%' // optional
            });
        ...
        function teclaEnter() {
            if (event.keyCode == "13") {
                ...
                document.getElementById("<%=aPerquisaCadAutAlunosAlunos.ClientID%>").click();
            }
        }
