<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="cadProfessor.aspx.cs" Inherits="SERPI.UI.WebForms_C.cadProfessor" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-9">
            <h3 class=""><i class="fa fa-circle-o text-primary"></i>&nbsp;<strong >Professor</strong> (Listagem)</h3>
        </div>

        <div class="col-md-3">
            <br />
            <div class ="pull-right ">
                <button type="button"  runat="server" id="btnCriarProfessor" name="btnCriarProfessor" class="btn btn-success" href="#" onclick="" onserverclick="btnCriarProfessor_Click" >
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            ...
                            <a id="aBntPerquisaProfessor" runat ="server" onclick="fProcessando()" onserverclick="btnPerquisaProfessor_Click" href="#" class ="btn btn-success pull-right"><i class="glyphicon glyphicon-ok"></i><span>&nbsp;OK</span></a>
                        </div>
                                    ...
                                    <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Foto" HeaderStyle-HorizontalAlign="Justify" ItemStyle-HorizontalAlign="Center"  ItemStyle-CssClass="centralizarTH" HeaderStyle-CssClass="centralizarTH">
                                                <ItemTemplate>
                                                    <%# setLinkImagem(DataBinder.Eval(Container.DataItem, "cpf").ToString(), DataBinder.Eval(Container.DataItem, "Nome").ToString())%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="id_professor" HeaderText="ID" ItemStyle-HorizontalAlign="Center" />

                                            <asp:BoundField DataField="nome" HeaderText="Nome" />

                                            <asp:TemplateField HeaderText="Tipo" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#DataBinder.Eval(Container.DataItem, "cpf_passaporte").ToString() == "0" ? "CPF" : "Passaporte"%>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:BoundField DataField="cpf" HeaderText="CPF/ Passaporte" HeaderStyle-Wrap="true" ItemStyle-Wrap="true" ItemStyle-HorizontalAlign="Center"/>

                                            <asp:BoundField DataField="numero_documento" HeaderText="Doc. de Identificação" ItemStyle-HorizontalAlign="Center" />

                                            <asp:BoundField DataField="email" HeaderText="Email" />

                                            <asp:BoundField DataField="titulacao.nome" HeaderText="Titulação"  ItemStyle-HorizontalAlign="Center"/>

                                            <asp:BoundField DataField="celular_res" HeaderText="Celular"  ItemStyle-HorizontalAlign="Center"/>
