<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="admArquivoGestao.aspx.cs" Inherits="SERPI.UI.WebForms_C.admArquivoGestao" %>
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-8">
            <h3 class=""><i class="fa fa-circle-o text-aqua"></i>&nbsp;<strong >Arquivo p/ Portal</strong> <asp:Label ID="lblTituloPagina" runat="server" Text="(novo)"></asp:Label></h3>
        ...
        <div class="col-md-2">
            ...
            <button type="button"  runat="server" id="btnCriarVideo" name="btnCriarVideo" class="btn btn-primary pull-right" href="#" onclick="" onserverclick="btnCriarVideo_Click" > <%--onserverclick="btnCriarVideo_Click"--%>
                    <i class="fa fa-magic"></i>&nbsp;Cadastrar novo Arquivo</button>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-10 ">
                                    ...
                                    <textarea style ="resize:vertical; font-size:14px" runat ="server" id="txtDescArquivo" class="form-control input-sm" rows="2" maxlength="200"></textarea>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    ...
                                    <input class="form-control input-sm" runat="server" id="txtNomeArquivo" type="text" value="" readonly="true" />
                                </div>
                                <div class="hidden-lg hidden-md">
                                    <br />
                                </div>
                                ...
                                <div class="col-md-2 ">
                                    <br />
                                    <button type="button" runat="server"  id="btnLocalizarArquivo" name="btnLocalizarArquivo" class="btn btn-primary center-block " onclick="javascript:fLocalizaArquivo()" > <%--onserverclick="btnVoltar_Click"--%>
...
<%--                                <source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4"/>
                                        <source src="./videos/Arquivo institucional do IPT 2014.mp4" type="video/mp4"/>--%>
    ...
    <div class="hidden">
        <asp:FileUpload ID="fileArquivoParaGravar" runat="server" accept=".jpg,.png,.pdf" onchange="javascript:fSelecionouArquivo(this);"  />
    </div>
...
<%--    <script src="Scripts/jquery.datatable.1.10.13.min.js"></script>--%>
    ...
    <script>
        ...
        function fSelecionouArquivo(idFile) {
            ...
            if (vFileExt.toUpperCase() == "JPG" || vFileExt.toUpperCase() == "PNG" || vFileExt.toUpperCase() == "PDF") {

                if (idFile.files && idFile.files[0]) {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        //$('#<%=idVideo.ClientID%>').attr('src', e.target.result);
                        document.getElementById('<%=txtNomeArquivo.ClientID%>').value = idFile.files[0].name;
                    }
