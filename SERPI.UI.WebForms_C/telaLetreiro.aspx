<%@ Page Title="" Language="C#" MasterPageFile="~/SERPI.Master" AutoEventWireup="true" CodeBehind="telaLetreiro.aspx.cs" Inherits="SERPI.UI.WebForms_C.telaLetreiro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <input type="hidden" id ="hItemMenu"  name="hItemMenu" value="liMonitorLetreiro" />
...
<%--    <link href="Content/jquery.datatable.1.10.13.min.css" rel="stylesheet" />--%>
    ...
    <div class="row"> 
        <div class="col-md-10">
            <h3 class=""><i class="fa fa-circle-o text-red"></i>&nbsp;<strong >Letreiro</strong></h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-10 ">
                                    ...
                                    <textarea style ="resize:vertical; font-size:14px" runat ="server" id="txtDescLetreiro" class="form-control input-sm" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
